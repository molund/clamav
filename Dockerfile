...
RUN wget -t 5 -T 99999 -O /opt/app-root/src/main.cvd https://database.clamav.net/main.cvd && \
   wget -t 5 -T 99999 -O /opt/app-root/src/daily.cvd https://database.clamav.net/daily.cvd && \
   wget -t 5 -T 99999 -O /opt/app-root/src/bytecode.cvd https://database.clamav.net/bytecode.cvd && \
